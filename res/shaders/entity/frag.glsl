...
//solutoin G: copy the uniform elemtn from vert to frag
...
#endif
//solution H:add the direcional light data from vert shader
#if NUM_DL > 0
...
void main() {
    //solution G:copy the caculationg of light from vert.glsl, and change the element form the vertex_out to frag_in.
