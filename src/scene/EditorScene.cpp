...
void EditorScene::EditorScene::open(const SceneContext& scene_context) {
    ...
    light_generators = {
        ...
        // Solution: H (13/16): Register directional lights so the editor UI can create them like point lights.
    ...
    json_generators = {
        ...
        // Solution: H (14/16): Register the JSON loader so saved directional lights are restored with the scene.
